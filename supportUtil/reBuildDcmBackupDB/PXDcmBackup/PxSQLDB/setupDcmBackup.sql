...
INSERT INTO dbo.RoutingSchedule (ScheduleID,RoutingPatternID) values(0,@RoutingPattern_id);


-- add LocalAE  ---

IF NOT EXISTS ( SELECT * FROM dbo.LocalAE WHERE  AEName = 'DENTALCT_AE' )
INSERT INTO dbo.LocalAE (AEName,AETitle,HostName,IPAddress,Port) 
values('DENTALCT_AE','DENTALCT_AE','localhost','120.0.0.1',6103);

IF NOT EXISTS ( SELECT * FROM dbo.LocalAE WHERE  AEName = 'DcmBackup_AE' )
INSERT INTO dbo.LocalAE (AEName,AETitle,HostName,IPAddress,Port) 
values('DcmBackup_AE','DcmBackup_AE','localhost','120.0.0.1',6103);
