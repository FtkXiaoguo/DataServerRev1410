 ...
 *
 * $Workfile: aw_j2k_dtypes.h $    $Revision: 20540 $   
 * Last Modified: $Date: 2005-10-27 01:45:20 +0900 (木, 27 10 2005) $ by: $Author: li $
 *
 **********************************************************************/
...
#define _DTYPES_H_
#ifndef Macintosh
static const char id_dtypes_h[] = "@(#) $Header$ Aware Inc.";
#endif /* Macintosh */
