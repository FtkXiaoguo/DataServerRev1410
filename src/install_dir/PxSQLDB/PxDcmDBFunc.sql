...
CREATE PROCEDURE MakePatient  (
	...
	@StudyID VARCHAR(16), 
	@ReferringPhysiciansName NVARCHAR(332), 
...
BEGIN
	...
	declare @PatientsName NVARCHAR(332)
	...
	declare @ReferringPhysiciansName NVARCHAR(332)
	...
	declare @SeriesDescription NVARCHAR(64)
...
CREATE PROCEDURE MakeStudy  (
	...
	@AccessionNumber VARCHAR(16), 
	@StudyID VARCHAR(16), 
	@ReadingPhysiciansName NVARCHAR(332),
	@ReferringPhysiciansName NVARCHAR(332), 
