...
set JPEGGATEWAY_NAEM=JPEGGateway
IF %0%1 == %0 goto INSTALL_START
set JPEGGATEWAY_NAEM=%1
:INSTALL_START
...
echo ===== start install (%JPEGGATEWAY_NAEM%) Ver 3.2.1.0 ====== >> %LOG_FILE%
echo ===== start install (%JPEGGATEWAY_NAEM%) Ver 3.2.1.0 ====== 
...
mkdir C:\PXDcmGatewayMediaP
mkdir C:\PXDcmGatewayMediaP\PXDICOM_R
...
rem =========================
echo --- setupGateway----  >> %LOG_FILE%
cd PxSQLDB
call .\setupGateway.bat
cd ..
