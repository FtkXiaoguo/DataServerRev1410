...
begin	
	...
	INSERT dbo.StoreTargetAE Select ID FROM dbo.RemoteAE WHERE AEName='FC-SERV_AE'
end
...
SELECT @StoreTarget_id=ID FROM dbo.RemoteAE WHERE AEName = 'FC-SERV_AE';
