================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: PXMediaPoint プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した PXMediaPoint には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには PXMediaPoint アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
PXMediaPoint.h
   ...
   CPXMediaPointApp アプリケーション クラスを宣言します。

PXMediaPoint.cpp
   これは、アプリケーション クラス CPXMediaPointApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\PXMediaPoint.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル PXMediaPoint.rc に含まれていま
   す。

res\PXMediaPoint.rc2
...
PXMediaPointDlg.h, PXMediaPointDlg.cpp - ダイアログ
   これらのファイルは CPXMediaPointDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な PXMediaPoint.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   PXMediaPoint.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
