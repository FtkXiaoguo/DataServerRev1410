========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : modifyDicomPA
========================================================================


AppWizard が生成した modifyDicomPA には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには modifyDicomPA を構成している各ファイルの概要説明が含まれています。
...
modifyDicomPA.h
    ...
    みます） をインクルードし、また CTstCDRomApp アプリケーションクラスを宣
    言します。

modifyDicomPA.cpp
    このファイルは CTstCDRomApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\modifyDicomPA.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル modifyDicomPA.rc によってインクルード
    されます。

res\modifyDicomPA.rc2
...
modifyDicomPADlg.h, modifyDicomPADlg.cpp - ダイアログ
    これらのファイルは CTstCDRomDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な modifyDicomPA.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) modifyDicomPA.pch 
