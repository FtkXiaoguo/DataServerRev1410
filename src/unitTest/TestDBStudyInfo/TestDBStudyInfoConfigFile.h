 ...
 *-------------------------------------------------------------------
 */
#ifndef TEST_DB_TESTSTUDYINFO_CONFIG_FILE_H
#define TEST_DB_TESTSTUDYINFO_CONFIG_FILE_H
...
class TestDBStudyInfoConfigFile : public iRTVOptions // RTVConfigFile
{
public:
	TestDBStudyInfoConfigFile();
	~TestDBStudyInfoConfigFile() {}
...
#endif // TEST_DB_TESTSTUDYINFO_CONFIG_FILE_H