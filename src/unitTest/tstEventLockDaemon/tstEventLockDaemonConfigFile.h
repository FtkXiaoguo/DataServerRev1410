 ...
 *-------------------------------------------------------------------
 */
#ifndef TEST_EVENT_LOCK_DAEMON_CONFIG_FILE_H
#define TEST_EVENT_LOCK_DAEMON_CONFIG_FILE_H
...
class TestEvtLockDaemonConfigFile : public iRTVOptions // RTVConfigFile
{
public:
	TestEvtLockDaemonConfigFile();
	~TestEvtLockDaemonConfigFile() {}
...
//	char m_defaultLocalAETitle[256];
	...
	int m_GlobalResourceName;
};

#endif // TEST_EVENT_LOCK_DAEMON_CONFIG_FILE_H