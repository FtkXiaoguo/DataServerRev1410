/***********************************************************************
 * TestDBDaemonConfigFile.cpp
 *---------------------------------------------------------------------
 *		Copyright, TeraRecon 2001, All rights reserved.
 *
 *	PURPOSE:
 *		Read TIDICOMServer configuration file 
 *
...
TestDBDaemonConfigFile::TestDBDaemonConfigFile()
{
}

void TestDBDaemonConfigFile::Init()
{
...
//	strcpy(m_defaultLocalAETitle, kDefaultLocalAETitle);
	...
	configFile = configRootPath+"TestDBDaemon.cfg";
	strcpy(gConfig.m_serverNameStr, "AQNetDICOMServer");
	strcpy(gConfig.m_logFilename,   "c:/AQNetLog/TestDBDaemon.log");
...
strcpy(gConfig.m_configFilename,"testBKOpenGL.log");
...
void TestDBDaemonConfigFile::InitKVPMap()
{
...
void TestDBDaemonConfigFile::ValidateAndFixConfiguration()
{
